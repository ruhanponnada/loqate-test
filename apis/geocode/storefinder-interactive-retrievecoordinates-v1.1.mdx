---
title: "Storefinder Interactive Retrievecoordinates v1.1"
description: ""
sidebarTitle: "Storefinder Interactive Retrievecoordinates v1.1"
---
...
```
https://api.addressy.com/storefinder/interactive/retrievecoordinates/v1.1/
```
...
```
https://api.addressy.com/storefinder/interactive/retrievecoordinates/v1.1/wsdl3.ws
```
...
| Id\*  | String |        | The ID of the location to get the coordinates for. Use the FindPlaceNames to get the Id. |
...
| --------- | ------- | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------- |
| Id        | String  | GBR\|1717050 | The ID for this company. This is not the URN.                                                                                                |
...
| 1002 | Id Invalid | The Id parameter was not a recognised Id. | Check the Id and ensure it's come from a Find service. |
...
https://api.addressy.com/StoreFinder/Interactive/RetrieveCoordinates/v1.10/dataset.ws?Key=AA11-AA11-AA11-AA11&Id=GBR|PC|1717050
...
function StoreFinder_Interactive_RetrieveCoordinates_v1_10(Key, Id)
      ...
      'Build the url
      strUrl = "https://api.addressy.com/StoreFinder/Interactive/RetrieveCoordinates/v1.10/recordset.ws?"
      ...
      set StoreFinder_Interactive_RetrieveCoordinates_v1_10 = rst
