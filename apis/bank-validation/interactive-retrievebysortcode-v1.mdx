---
title: "Interactive Retrievebysortcode V1"
description: ""
sidebarTitle: "Interactive Retrievebysortcode V1"
---
...
```
https://api.addressy.com/bankaccountvalidation/interactive/retrievebysortcode/v1/
```
...
```
https://api.addressy.com/bankaccountvalidation/interactive/retrievebysortcode/v1/wsdl3.ws
```
...
| SortCode\* | String |        | The branch sortcode.                           |
...
```
https://api.addressy.com/BankAccountValidation/Interactive/RetrieveBySortcode/v1.00/dataset.ws?Key=AA11-AA11-AA11-AA11&SortCode=11-22-33
```
...
```asp ASP function
function BankAccountValidation_Interactive_RetrieveBySortcode_v1_00(Key, SortCode)
      ...
      'Build the url
      strUrl = "https://api.addressy.com/BankAccountValidation/Interactive/RetrieveBySortcode/v1.00/recordset.ws?"
      ...
      set BankAccountValidation_Interactive_RetrieveBySortcode_v1_00 = rst
